              ...
              Container(
                ...
                child: ListView(
                  ...
                  children: <Widget>[
                    ...
                    myArticles("http://funmusic.name/menu/menu02.jpg",
                        "ส้มตำปูม้า", "180บาท"),
                    myArticles("http://funmusic.name/menu/menu03.jpg",
                        "แกงส้มไข่ปลาเรียวเซียว", "380บาท"),
                    myArticles("http://funmusic.name/menu/menu04.jpg",
                        "แกงส้มกุ้งสด", "280บาท"),
                    myArticles("http://funmusic.name/menu/menu05.jpg",
                        "หอยแครงลวก", "120บาท"),
                    myArticles("http://funmusic.name/menu/menu06.jpg",
                        "แกงไหลบัว", "180บาท"),
                    myArticles("http://funmusic.name/menu/menu07.jpg",
                        "ตำซั่วหอยแครง", "140บาท"),
                    myArticles("http://funmusic.name/menu/menu08.jpg",
                        "คอหมูย่าง", "100บาท"),
